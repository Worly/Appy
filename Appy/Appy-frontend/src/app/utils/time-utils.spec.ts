...
describe('timeBetweenMs', () => {
  it('is positive for a gap (15 min)', () => {
    ...
    expect(timeBetweenMs(at("10:00"), mins(30), at("10:45"))).toBe(15 * 60 * 1000);
  });

  it('is zero for back-to-back', () => {
    expect(timeBetweenMs(at("10:00"), mins(30), at("10:30"))).toBe(0);
  });

  it('is negative for an overlap (15 min)', () => {
    // 10:00 + 45m ends 10:45; next starts 10:30 → overlaps 15m
    expect(timeBetweenMs(at("10:00"), mins(45), at("10:30"))).toBe(-15 * 60 * 1000);
  });
